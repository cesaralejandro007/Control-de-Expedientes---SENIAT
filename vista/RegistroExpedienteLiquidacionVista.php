...
<input type="hidden" name="id_expediente_user" id="id_expediente_user"/>
                      ...
                      <div class="modal-body">
                        <form class="row g-3 needs-validation" novalidate>
                          ...
                          <div class="input-group">
                            <label class="input-group-text" for="AddFiscal">Asignar Revisor</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Asignar Revisor</h5>
...
<span class="text-danger" id="validacion_cam_fun"></span>
  ...
  <script src="content/js/ExpedientesLiquidacion.js"></script>
  <script>
