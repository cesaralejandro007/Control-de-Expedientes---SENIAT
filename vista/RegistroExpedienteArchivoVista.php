...
<div class="d-flex justify-content-between align-items-end">
  ...
  <div class="py-3 px-4" style="border-radius: 0 0 0 50%; background:#FFC300;">
    <h1 class="m-0">Lista de Expedientes del Área de Archivo</h1>
  </div>
</div>
                      ...
                      <div class="modal-body">
                        <form class="row g-3 needs-validation" novalidate>
                          ...
                          <div class="input-group">
                            <label class="input-group-text" for="AddFiscal">Asignar Archivista</label>
                  ...
                  <table id="funcionpaginacion" class="table datatable table-light table-striped table-hover">
                    <thead>
                      ...
                      <th scope="col">Nro de Expediente</th>
                        <th scope="col">Archivista Asignado</th>
  ...
  <script src="content/js/ExpedientesArchivo.js"></script>
  <script>
