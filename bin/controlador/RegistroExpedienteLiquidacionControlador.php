<?php
use modelo\RegistroExpedienteLiquidacionModelo as Expedientes;
...
if (is_file("vista/" . $pagina . "Vista.php")) {
    ...
    if (isset($_POST['accion'])) {
        $accion = $_POST['accion'];
        $modulo = 'Expedientes:';
        $division_actual = 'División de Recaudación';
    if ($accion == 'registrar') {
        ...
        return 0;
            ...
            $response = $Expediente->actualizar_area_expediente($_POST['id_area'],$_POST['id_expediente'],"División de Recaudación");
    ...
    $r4 = $Expediente->listar_area("División de Recaudación");
