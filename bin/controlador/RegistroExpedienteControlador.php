...
if (is_file("vista/" . $pagina . "Vista.php")) {
    ...
    if ($accion == 'registrar') {
        ...
        return 0;
            ...
            $response = $Expediente->actualizar_area_expediente($_POST['id_area'],$_POST['id_expediente'],"División de Fiscalizacíon");
    ...
    $r4 = $Expediente->listar_area("División de Fiscalizacíon");
