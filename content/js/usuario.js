...
function carga() {
  ...
  document.getElementById("yourCedula").maxLength = 8;
  document.getElementById("yourCedula").onkeypress = function (e) {
    er = /^[0-9]*$/;
    validarkeypress(er, e);
  };
  document.getElementById("yourCedula").onkeyup = function () {
    r = validarkeyup(
      keyup_cedula,
      this,
      document.getElementById("syourCedula"),
  ...
  document.getElementById("yourName").maxLength = 30;
  document.getElementById("yourName").onkeypress = function (e) {
    er = /^[A-Za-z\s\b\u00f1\u00d1\u00E0-\u00FC]*$/;
    validarkeypress(er, e);
  };
  document.getElementById("yourName").onkeyup = function () {
    r = validarkeyup(
      keyup_nombre,
      this,
      document.getElementById("syourName"),
  ...
  document.getElementById("area").maxLength = 9;
...
function valida_registrar() {
  ...
  cedula = validarkeyup(
    keyup_cedula,
    document.getElementById("yourCedula"),
    document.getElementById("syourCedula"),
    "* El formato debe ser 99999999."
  );
  nombre_apellido = validarkeyup(
    keyup_nombre,
  ...
  if(document.getElementById("area").value == 0){
    document.getElementById("sarea").innerHTML ="* Seleccione un genero";
